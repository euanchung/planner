...
export async function auth(req) {
  ...
  return u ? { id: u.id, nick: u.nick, admin: !!u.admin, cls: u.cls || "4반", officer: u.officer || null } : null;
}

/* 관리자거나 반장/부반장인지 — 시간표 변경·반 공유 같은 민감한 조작을 허용할지 이걸로 판단한다 */
export const isManager = (me) => !!(me && (me.admin || me.officer === "leader" || me.officer === "vice"));
